...
export class RoutesComponent implements OnInit {
    ...
    tableConfig = {
        ...
        columns: [
            ...
            { header: 'Approved by', minWidth: '15rem', customCol: { field: 'tblRtdApproval', subfield: 'aprrovedBy', text: 'tblRtdApproval', subtext: 'aprrovedByRole',  title: 'ROLE - ' } },
            { header: 'Next To Approved By', minWidth: '15rem', customCol: { field: 'tblRtdApproval', subfield: 'nextApprovedBy', text: 'tblRtdApproval', subtext: 'nextApprovedByRole',  title: 'ROLE - ' } },
            { field: 'tblRtdApproval', subfield: 'comments', header: 'Approval Audits', minWidth: '15rem', jsonString: true },
